...
function change_data(elementID, dataID, name) {
    ...
    fetch("http://localhost:2500/change_menu", {
        method: "PUT", 
        credentials: 'include', 
        headers: {
...
function search_menu() {
    ...
    const url = `http://localhost:2500/search_menu?menu=${encodeURIComponent(menu)}`;
...
function delete_menu(name) {
    ...
    fetch("http://localhost:2500/delete_from_menu", {
        method: "DELETE", 
        credentials: 'include', 
        headers: {
            'Content-Type': 'application/json',
...
function add_menu() {
    ...
    fetch("http://localhost:2500/add_to_menu", {
        method: "POST", 
        credentials: 'include', 
        headers: {
            'Content-Type': 'application/json',
